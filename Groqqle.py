...
def main(api_key_arg: str = None, num_results: int = 10, max_tokens: int = 4096, default_summary_length: int = 300):
    st.set_page_config(page_title="Groqqle (Groq Search)",page_icon="https://github.com/mbrown1837/Groqqle/blob/main/images/sitelogo.png?raw=true", layout="wide", initial_sidebar_state="collapsed")
